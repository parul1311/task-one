                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-start">
                                            ...
                                            <a href="{{ route('login-as', $user->id) }}" class="btn btn-dark btn-sm ms-2" title="Login as User"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-square" viewBox="0 0 16 16">
